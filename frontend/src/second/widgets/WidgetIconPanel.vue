<template>
    <div class="panel_main">
        <div class="wrapper" :class="{'selected':item.name==test}"  v-for="(item, index) in widgets" :key="index">
...
import {getWithStorageVariableCache,setWithStorageVariableCache} from '../../store'
